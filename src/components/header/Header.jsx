...
export function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 z-50 w-screen h-[8vh] shadow-sm bg-white">

            {/* desktop */}
            <div className="hidden md:flex justify-between items-center h-[8vh] px-7 p-2">
                ...
                <div className='menu'>
                    <ul className='flex'>
                        {navBar.map((list, i) => (
                            <li className={`font-semibold mx-5 py-2 ${activeNavLink}`} key={i}>
            ...
            <div className='flex items-center justify-between md:hidden h-full pl-2 pr-8'>
                ...
                <div>
                    {isMenu && (
                        <div className='bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-[8vh] left-0 w-full'>

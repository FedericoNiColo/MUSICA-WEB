            ...
            <section className="sidebar hero">
                ...
                <div className="flex justify-between">
                    <div className="bg-secondary text-white flex center px-2 py-0.5 rounded-md">
                        ...
                        <div className="">
                            <span className="text-gray-300 text-[12px]">Dowload on the</span>
                            <h3 className="text-md font-semibold">App Store</h3>
                        </div>
                    </div>
                    <div className="bg-secondary text-white flex center px-2 py-0.5 rounded-md">
                        <div className="">
                        ...
                        <div className="">
                            <span className="text-gray-300 text-[12px]">Dowload on the</span>
                            <h3 className="text-md font-semibold">Google Play</h3>
                        </div>
                    </div>

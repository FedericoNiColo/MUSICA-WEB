...
export function Card_sm({ cover, name, tag, i, show }) {

    return (
        <>
            <div className='box card relative flex hover:bg-gray-100 p-2 rounded-md transition ease-in-out cursor-pointer'>
